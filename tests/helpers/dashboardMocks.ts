...
export function mockBulkCreateResponse(
  options: {
    created?: number;
    skipped?: number;
    projectId?: number;
...
export function mockListTasksResponse(
  count: number = 5,
  _projectId: number = 1,
): TaskListResponse {
  const tasks = [];
...
export function mockTaskCreateInput(
...
export function mockTaskUpdateInput(
...
export function priorityToPriorityScore(
