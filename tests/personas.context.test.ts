...
describe("Contextual Persona Prompts", () => {
  ...
  describe("Prompt content validation", () => {
    it("all plan-evaluator prompts avoid confusion between planning and QA", () => {
      const planningPrompt =
        CONTEXT_SPECIFIC_PROMPTS["plan-evaluator"]["planning"];
    ...
    it("revision prompt is genuinely more lenient", () => {
      const revisionPrompt =
        CONTEXT_SPECIFIC_PROMPTS["plan-evaluator"]["revision"];
  ...
  describe("Implementation-planner contexts", () => {
    it("qa-fix context is more focused than default", () => {
      const defaultPrompt =
        CONTEXT_SPECIFIC_PROMPTS["implementation-planner"]["default"];
      const qaFixPrompt =
        CONTEXT_SPECIFIC_PROMPTS["implementation-planner"]["qa-fix"];
