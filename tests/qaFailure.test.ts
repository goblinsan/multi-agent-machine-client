...
import {
  createDynamicTaskMocking,
  createFastCoordinator,
} from "./helpers/coordinatorTestHelper.js";
...
describe("Coordinator QA failure plan evaluation", () => {
  it("processes QA failure workflow without hanging (business outcome)", async () => {
    ...
    vi.spyOn(coordinator as any, "processTask").mockImplementation(
      async (task: any, _context: any) => {
