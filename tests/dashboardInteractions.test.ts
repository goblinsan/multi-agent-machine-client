...
import {
  TaskCreateUpsertSchema as _TaskCreateUpsertSchema,
  TaskStatusUpdateSchema as _TaskStatusUpdateSchema,
  validate as _validate,
} from "./helpers/dashboardSchemas.js";
...
describe("dashboard interactions", () => {
  it("createDashboardTask uses /projects/:projectId/tasks endpoint with external_id for idempotency", async () => {
    ...
    const call = calls.find((c) =>
      c.url.includes("/projects/11111111-1111-1111-1111-111111111111/tasks"),
    );
  ...
  it("updateTaskStatus requires projectId - throws error if missing", async () => {
    ...
    await expect(taskAPI.updateTaskStatus("task-123", "done")).rejects.toThrow(
